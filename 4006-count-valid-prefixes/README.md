<h2><a href="https://leetcode.com/problems/count-valid-prefixes">4006. Count Valid Prefixes</a></h2><h3>Easy</h3><hr><p>You are given a <span data-keyword="binary-string">binary string</span> <code>s</code>.</p>
